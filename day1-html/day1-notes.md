...
1. Semantic HTML: Elements that convey content meaning, improving accessibility and SEO (short phrase: header, article).
2. <section> vs <div>: `section` groups thematically related content (usually with a heading); `div` is a generic container for layout/styling.
